...
export const NGE_MARKDOWN_EMOJI_OPTIONS =
  new InjectionToken<NgeMarkdownEmojiOptions>('NGE_MARKDOWN_EMOJI_OPTIONS');
 ...
 */
export function NgeMarkdownEmojiOptionsProvider(
  options: NgeMarkdownEmojiOptions
): Provider {
  return {
