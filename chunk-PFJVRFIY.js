...
NG Essentials is a collection of libraries for `),s(12,"a",2),e(13,"Angular"),i(),e(14,` developers.
...
Browser would open automatically at <//localhost:4200/>.

## \u{1F91D} Contribution

Contributions are always welcome. `),a(16,"br"),e(17,`
...
`),i())},dependencies:[d],styles:["[_nghost-%COMP%]{display:block;width:100vw;height:100vh;padding:2rem 8rem;box-sizing:border-box}@media only screen and (max-width: 600px){[_nghost-%COMP%]{padding:2rem}}"]});let n=t;return n})();var M=(()=>{let t=class t{};t.\u0275fac=function(o){return new(o||t)},t.\u0275mod=h({type:t}),t.\u0275inj=c({imports:[p,l,g.forChild([{path:"",component:u}])]});let n=t;return n})();export{M as HomeModule};
